...
public class Main
{
    ...
    private static final String initScript = "/init.js";
    private static final String startScript = "/start.js";
    ...
    public static void processSource(Context cx, String filename)
    {
        ...
        processFile(cx, global, Global.class.getResource(startScript).toString());
        System.gc();
    }
